...
export class ChartComponent {
  ...
  ngAfterViewInit() {
    ...
    this.browserOnly(() => {
      ...
      try {
          chart.geodata = am4geodata_moroccoHigh;
      }
      catch (e) {
      ...
      polygonSeries.include = ["MA-12", "MA-11", "MA-10", "MA-09", "MA-08", "MA-07", "MA-06", "MA-05", "MA-04", "MA-03", "MA-02", "MA-01"]
      ...
      countryLabel.text = "Select a department";
